  ...
  return (
    ...
    >
      <div className="container">
        <div className="intro">
          <img src="images/profile/profile-4.png" alt="Bolby" className="mb-4" />

          <h1 className="mb-2 mt-0">Hendry Agus Setiawan</h1>
          <p>
            Saya seorang{" "}
            <Typed
              strings={[
          ...
          <p className="fw-light">
            Saya mempunyai minat untuk menjadi seorang Full Stack Web Developer.
          </p>
